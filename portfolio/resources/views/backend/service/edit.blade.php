...
<div class="card">
    <h5 class="card-header">Edit My Service</h5>
    <div class="card-body">
      <form method="post" action="{{route('service.update',$service->id)}}">
        ...
        <input id="inputTitle" type="text" name="nama_skill" placeholder="Enter Nama Service"  value="{{$service->nama_skill}}" class="form-control">
        @error('nama_skill')
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="level" placeholder="Enter Level"  value="{{$service->level}}" class="form-control">
          @error('level')
          <span class="text-danger">{{$message}}</span>
          @enderror
          </div>
